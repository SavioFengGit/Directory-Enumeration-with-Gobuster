...
gobuster dir -u http://192.128.80.3 -w /usr/share/wordlists/dirb/common.txt -b 403,404 (enumeration, ignoring status 403 and 404) <br>
<img src="g1.png" width=80% height="auto"><br>
gobuster dir -u http://192.128.80.3/data -w /usr/share/wordlists/dirb/common.txt -b 403,404 -x .php,.xml,.txt -r (Find the files with the extensions such as .php, .xml, .txt in the directory /data enumerated with the previous command) <br>
